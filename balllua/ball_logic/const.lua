...
local CmdType = {
    ...
    ROLE_SKILL = 3,     -- 角色使用技能，{type:3, cid:1, target: {x:1, y:1}, cd:3, range:{x:100,y:100, width:200, height:200}} cid:角色id， target：格子xy，cd：冷却回合数，range：影响格子
    ...
    SKILL_READY = 8,    -- 技能准备 {type:8, cid:1, grid: 20, grids: []} cid:角色id grid: 目标格，grids所有受影响的格子

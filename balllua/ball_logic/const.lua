local CmdType = {
    ...
    SKILL_EFFECT = 5,   -- 技能效果（被动技能，或者持续性技能触发），{type:5, cid: 1, effects:[{dmg:{id:1, dmg:10, hp:100}, evts:{type:1, id:1001, cid:9, grid:3}},...]} cid: 技能id，effects技能效果，同弹射伤害结构
    ENEMY_MOVE = 6,     -- 敌方移动（暂缺）
